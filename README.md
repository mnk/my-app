Reproducer for Maven 4.0.0-rc-5 profile activation bug: https://github.com/apache/maven/issues/10375
====================================================================================================
...
Show that profile is activated in both parent and child project
    ...
    $ ./mvnw -q wrapper:wrapper -Dmaven=4.0.0-rc-5 && ./mvnw validate | grep "Profile activated"
    [WARNING]      [echo] Profile activated in my-app: Test 1

With Maven 4 RC, the profile is only activated in parent project, even if

    $ ./mvnw -q wrapper:wrapper -Dmaven=4.0.0-rc-5 && ./mvnw -q help:all-profiles -Doutput=/dev/pts/0
